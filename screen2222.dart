  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          Text("Add New Seller", style: TextStyle(color: Colors.brown, fontSize: 25,fontWeight: FontWeight.bold),), 
                         SizedBox(height: 10,),
                         Container(
                          width: 100,
            ...
            TextButton(
              onPressed: () =>Navigator.push(context, MaterialPageRoute(builder:(context) => screen3_1(),)),
